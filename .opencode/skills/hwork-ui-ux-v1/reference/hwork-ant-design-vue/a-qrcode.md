...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" :status="status" />
</template>
```
...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" :size="size" />
</template>
```
...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" icon="..." />
</template>
```
...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" type="svg" />
</template>
```
...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" color="#1890ff" :style="{ backgroundColor: '#f0f0f0' }" />
</template>
```
...
```vue
<template>
  <a-qrcode value="https://www.antdv.com/" :error-level="errorLevel" />
</template>
```
...
> 有关更多信息，可参阅相关资料：https://www.qrcode.com/zh/about/error_correction.html

---

**文档来源**: https://design.hwork.haier.net/fe-docs/ant-design-vue4/components/qrcode-cn
