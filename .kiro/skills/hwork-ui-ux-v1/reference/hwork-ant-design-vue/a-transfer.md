...
| footer | 可以设置为一个作用域插槽 | `slot="footer" slot-scope="props"` | - | - |
...
| pagination | 使用分页样式，自定义渲染列表下无效 | `boolean \| { pageSize: number, simple: boolean, showSizeChanger?: boolean, showLessItems?: boolean }` | `false` | 3.0.0 |
